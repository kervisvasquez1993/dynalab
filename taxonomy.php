	...
	<main class="main_block">
		 		...
		 		<div class="menu" id="menu_filtro">
				   <?php $imagen_principal = get_field('img_taxonomia',$taxonomia_actual);
					...
					$imagen_principal = get_field('img_taxonomia2',$taxonomia_actual);?>
			        ...
			        <?php while($farmaco->have_posts()): $farmaco->the_post();?>
					   ...
					   <div class="card">
                            ...
                            <div class="card-content " style="border-top: 3px solid <?php the_field('color');?>;
                                                  ...
                                                  <?php if($taxonomia_actual->name == "Productos con Prescripción"){?>
                                                        <img src='<?php the_field('imagen_categoria_principal') ?>'>
                                                  
                                                  <?php };?>
                                                  <?php if($taxonomia_actual->name == "Productos Hospitalarios"){?>
                                                        <img src='<?php the_field('imagen_categoria_principal2') ?>'>
                                                  <?php };?>
                                                  <?php if($taxonomia_actual->name == "Productos OTC"){?>
                           ...
                           <div class="card-reveal">
                                   ...
                                   <p><?php the_content();?></p>
								   <div class="ver_prospecto"><a href="<?php the_field('agregar_archivo');?>" class="pdf">Ver Prospecto</a></div>
                                </div>
                        </div>
					   </div>
